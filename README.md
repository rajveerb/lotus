...
```bash
python code/visualize_P3Torch_trace/visualization_augmenter.py --p3torch_trace_dir <p3torch_trace_dir> --coarse --output_p3torch_viz_file <viz_file_path>
```
...
For more options:
```bash
python code/visualize_P3Torch_trace/visualization_augmenter.py --help 
```
